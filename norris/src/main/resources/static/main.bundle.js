...
module.exports = "<h1>\n  {{title}}\n</h1>\n<button (click)=\"sayHello()\">Get a Chuck Norris Fact</button>\n<h3>Hello, welcome to your Chuck Norris Fact:</h3>\n<br/>\n<br/>\n<span>{{result}}</span>\n\n\n"
...
var AppComponent = (function () {
    function AppComponent(http) {
        this.http = http;
        this.title = 'Chuck Norris Legends (offensive, please disregard)';
        this.result = '';
    }
